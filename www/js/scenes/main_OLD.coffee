class Scene.Main extends Phaser.State
  ...
  create: ->
    ...
    @soldier.pivot = new Phaser.Point(-5, 0)

    # @soldier.turret = @game.add.sprite(@soldier.x, @soldier.y)

    # @soldier.turret.anchor.setTo(-1, -1)
    ...
    @gunner.body.setSize(50, 50, 25, 25)
  ...
  update: ->
    ...
    # @soldier.turret.reset(@soldier.x, @soldier.y)
    
    # @soldier.turret.rotation = @soldier.rotation
